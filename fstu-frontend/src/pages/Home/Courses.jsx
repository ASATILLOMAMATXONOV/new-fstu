...
const LeaderCard = ({ leader }) => (
  ...
  >
    ...
    <Box sx={{ textAlign: { xs: 'center', sm: 'left' } }}>
      <Typography fontWeight={700}>{leader.name}</Typography>
      <Typography fontWeight={600} color="var(--primary-blue)">
        {leader.role}
      </Typography>
...
const AsideMenu = () => (
  ...
  >
    <Typography fontWeight={800} mb={2}>Menu</Typography>

    <Stack spacing={0.5}>
      {[
        { label: 'Rahbariyat', to: '/management' },
        { label: 'Tashkiliy tuzilma', to: '/structure' },
        { label: 'Rasmiy nizom', to: '/regulations' },
        { label: 'Qabul jadvali', to: '/reception-schedule' },
      ].map(item => (
       <Button
  key={item.to}
  component={Link}
